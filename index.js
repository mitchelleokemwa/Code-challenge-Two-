...
function onSpaceCharacterClick (event) {
...
document.getElementById("votes-form").addEventListener("submit", (event)  => {
  ...
  votes.innerText = parseInt(votesForm.voes.value) + parseInt(votes.innerText)
  votesForm.rest();
})
